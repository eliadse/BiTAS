...
int FullCameraLCCoordsTeVMZd(const char *runfiles, const char *LCfile, const char *source, const double dispCut, const char *period){
...
///////////////////////
    ...
    for (int i = 0; i < nEntries; i++){
        ...
        if (poPos->GetCorrZd() < 35.|| poPos->GetCorrZd() > 50) continue;
        
        Double_t en = stereoDisp->GetEnergy();  
        if (en < 200 || en > 10000) continue;
        //if (en < 200 || en > 25000) continue;
